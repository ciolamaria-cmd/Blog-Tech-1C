...
// Exibe uma mensagem no console do navegador apenas para testar se o clique funcionoa
console.log("fui clicado");
// Procura e seleciona a tag <span> (o número do contador) que está dentro deste botão let texto 
